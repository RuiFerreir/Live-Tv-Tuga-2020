...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.amerikanopremiumjr/resources/ivue','addons_index.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.amerikanopremiumjr/resources/ivue','addons_index.zip'))
...
def iVueInt():
	...
	dp.create("[COLOR lime]Amerikano Premium JR [/COLOR]","Copying ini",'', 'Please Wait')
	unzip(inizip,ivuecreate,dp)
	time.sleep(5)
	a = open(ivuecreateini).read()
	b = a.replace('<Amerikano Premium JRIPTV2UN>',username).replace('<Amerikano Premium JRIPTV2PW>',password)
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.amerikanopremiumjr/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.amerikanopremiumjr/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("[COLOR lime]Amerikano Premium JR [/COLOR]","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("[COLOR lime]Amerikano Premium JR [/COLOR]","Installing iVue TV Guide...",'', 'Please Wait')
